...
From v1.0, `ggVennDiagram` can plot up to seven dimension Venn plot. Please note that the shapes for this five sets diagram, as well as those for six and seven sets, are copied from the original package “venn”, authored by Adrian Dușa.
...
Adrian Dusa (2024) _venn: Draw Venn Diagrams_, R package version 1.12. <https://CRAN.R-project.org/package=venn>.
